...
public class PracticeShakerDriveTrain extends PracticeShakerSubsystem {
    ...
    private static final float LOW_GEAR_REDUCTION = 0;
    private static final float HIGH_GEAR_REDUCTION = 0;
    private static final float WHEEL_DIAMETER = 2 / 3;//wheel diamter in feet
    private static final float WHEEL_CIRCUMFERENCE = (float) Math.PI * WHEEL_DIAMETER;
    private static final float WHEEL_RPM = MOTOR_FREE_SPEED * (LOW_GEAR_REDUCTION - HIGH_GEAR_REDUCTION) / (LOW_GEAR_REDUCTION * 2 - HIGH_GEAR_REDUCTION * 2);
    private static final float SHIFT_POINT = (float) (WHEEL_RPM / 60.0 * WHEEL_CIRCUMFERENCE);
