...
public class PracticeShakerShooter extends ShakerSubsystem implements Runnable {
    ...
    public PracticeShakerShooter() {
        ...
        longPiston = new DoubleSolenoid(PracticePorts.PCM_MODULE, PracticePorts.LONG_PISTON_FORWARD, PracticePorts.LONG_PISTON_REVERSE);
        shortPiston = new DoubleSolenoid(PracticePorts.SECOND_PCM_MODULE, PracticePorts.SHORT_PISTON_FORWARD, PracticePorts.SHORT_PISTON_REVERSE);
...
//		System.out.println("Im being told to Reset!!");
    ...
    public void setShooterLow() {
        ...
        shortPiston.set(PracticeConstants.SMALL_PISTON_HIGH_STATE); // was reverse
        // //this is short
        // one
