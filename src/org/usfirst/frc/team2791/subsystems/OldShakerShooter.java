...
// firstLevelSolenoid = new Solenoid(Ports.PCM_MODULE,
// Ports.SHOOTER_PISTON_CHANNEL_FIRST_LEVEL);
// secondLevelSolenoid = new Solenoid(Ports.PCM_MODULE,
// Ports.SHOOTER_PISTON_CHANNEL_SECOND_LEVEL);
// // configuration
...
// SmartDashboard.putNumber("Ball Distance Sensor",
// ballCheckingSensor.getVoltage());
// SmartDashboard.putNumber("Left shooter Error",
// leftShooterTalon.getClosedLoopError());
// SmartDashboard.putNumber("Right shooter Error",
// rightShooterTalon.getClosedLoopError());
//
// }
//
...
// return ballCheckingSensor.getAverageVoltage() >
// Constants.THRESHOLD_BALL_DISTANCE;
// }
//
...
// leftShooterTalon.getEncVelocity());
// SmartDashboard.putNumber("Right shooter Speed",
// rightShooterTalon.getEncVelocity());
// SmartDashboard.putNumber("Left shooter Error",
// leftShooterTalon.getClosedLoopError());
// SmartDashboard.putNumber("Right shooter Error",
// rightShooterTalon.getClosedLoopError());
