...
public class OperatorHelper extends ShakerHelper {
    ...
    public void teleopRun() {
        if (opJoy.getButtonLB()) intake.pullBall();
        if (opJoy.getButtonRB()) intake.pushBall();
        if (opJoy.getDpadUp()) intake.extendIntake();
        if (opJoy.getDpadDown()) intake.retractIntake();
    }
