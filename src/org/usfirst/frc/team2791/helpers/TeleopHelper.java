...
public class TeleopHelper extends ShakerHelper {
    ...
    private void operatorRun() {
        ...
        if (operatorJoystick.getButtonB()) {
            ...
            // else run the manual controls, if it is autofiring this will do nothing
        ...
        if (operatorJoystick.getButtonRB()) {//this will run the servo either manually or override an autoshot
            ...
            if (shooter.getIfAutoFire())
                ...
                shooter.pushBall();
        } else if (!shooter.getIfAutoFire())//this just brings the servo back to its place if none of the previous cases apply
