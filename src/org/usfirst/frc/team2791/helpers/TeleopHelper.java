...
public class TeleopHelper extends ShakerHelper {
    ...
    private void driverRun() {
        ...
        //if any of the pid driver controls are being used dont let the triggers take control
        ...
        if (!(driverJoystick.getDpadUp() || driverJoystick.getDpadDown() || driverJoystick.getDpadLeft()
            ...
            else if (driverJoystick.getDpadRight())//90 degrees counter clockwise
                driveTrain.setAngle(driveTrain.getAngle() - 90, 0.4);
    ...
    private void operatorRun() {
        ...
        if (intake.getIntakeState().equals(PracticeShakerIntake.IntakeState.EXTENDED)) {
            ...
            // then run the delayed shooter movement that waits one second before moving the arm
