...
public class AutoLineUpShot {
	...
	private static double defaultMaxOut = 1;
	private static double angleMaxOutput = 1;
	private static double angleMaxAtLowError = 0.4;
	private static boolean doubleChekingVision = false;
	...
	public static void run() {
		...
		case 20:
			...
			driveTrain.setAngle(target, angleMaxOutput); // keep the drivetrain
															// engaged
		...
		case 30:
			...
			driveTrain.setAngle(target, angleMaxOutput);
